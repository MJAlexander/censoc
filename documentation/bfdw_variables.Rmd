...
For full documentation about the census variables, refer to the IPUMS wesbite: [https://usa.ipums.org/usa-action/variables/search](https://usa.ipums.org/usa-action/variables/search).
